...
import { MapXDataRow } from '../configs/map-xdata-row.js';


export class MapXData {
...
static getRootAsMapXData(bb:flatbuffers.ByteBuffer, obj?:MapXData):MapXData {
  return (obj || new MapXData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMapXData(bb:flatbuffers.ByteBuffer, obj?:MapXData):MapXData {
...
static endMapXData(builder:flatbuffers.Builder):flatbuffers.Offset {
...
static createMapXData(builder:flatbuffers.Builder, rowsOffset:flatbuffers.Offset):flatbuffers.Offset {
